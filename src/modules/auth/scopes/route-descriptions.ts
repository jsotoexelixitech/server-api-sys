...
const ROUTE_LABELS: Record<string, string> = {
  ...
  'POST /api/v1/external/getCotizacionPer': 'Cotización personas (legacy external)',
  'POST /api/v1/external/validateEmissionPerson': 'Pre-validación emisión personas',
  'POST /api/v1/external/createEmissionPerson': 'Emitir póliza personas (legacy)',
  // endosos:write
