...
const ROUTE_LABELS: Record<string, string> = {
  ...
  'POST /api/v1/viajero-nacional/plan': 'Plan fijo Viajero Nacional VIAJE3 (3 días)',
  'POST /api/v1/viajero-nacional/detalle': 'Detalle Sis2000 de VIAJE3',
  'POST /api/v1/viajero-nacional/frecuencia': 'Frecuencia E + 3 días de VIAJE3',
  'POST /api/v1/viajero-nacional/cotizacion': 'Cotización Viajero Nacional VIAJE3',
  'POST /api/v1/viajero-nacional/validacion': 'Validación pre-emisión VIAJE3',
  'POST /api/v1/viajero-nacional/emision': 'Emitir póliza Viajero Nacional VIAJE3',
  'POST /api/v1/viajero-margarita/plan': 'Plan fijo Viajero Margarita VIAJE4',
  'POST /api/v1/viajero-margarita/detalle': 'Detalle Sis2000 de VIAJE4 Margarita',
  'POST /api/v1/viajero-margarita/frecuencia': 'Frecuencia de VIAJE4 Margarita',
  'POST /api/v1/viajero-margarita/cotizacion': 'Cotización Viajero Margarita VIAJE4',
  'POST /api/v1/viajero-margarita/validacion': 'Validación pre-emisión VIAJE4 Margarita',
  'POST /api/v1/viajero-margarita/emision': 'Emitir póliza Viajero Margarita VIAJE4',
