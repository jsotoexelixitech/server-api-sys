...
export class ViajeroMargaritaController {
  ...
  @ApiOperation({
    ...
    description:
      'Emisión personas. Ramo, plan y vigencia de 7 días corridos (fhasta = fdesde + 7) los fija el servidor. Canal opcional en el body (`canal` o campos planos); no usa JWT.',
